      ...
      <div className="mx-5">
        <div className="my-5">
          {topic.includes("music") ? (
            <>
              <div className="flex gap-2 justify-center text-3xl my-5">
                <CiMusicNote1 />
            ...
            <div>{typeof topic}</div>
          )}
          <div className="md:flex-row flex-col flex gap-2 justify-between h-[50vh] md:[100vh] ">
            <div className="changing-images w-[90vw]  mx-auto">
              {/* Render the current image */}
              <img
                src={imgs[currentImageIndex]}
                alt={`Image ${currentImageIndex + 1}`}
                className="w-[90vw] h-[50vh] object-cover border-2 rounded-2xl "
              />
            </div>
            <div className="border-[1.25rem] border-green-950 h-[50vh] lg:w-[30vw] rounded-3xl flex flex-col ">
        ...
        <div className="my-5 md:mt-[0vh] mt-[50vh]">
          <div className=" tracking-widest  text-3xl my-5   opacity-70 ">
            MEET THE BOARD
          </div>
          <div className="  flex-wrap justify-between mx-auto md:flex-row flex flex-col gap-2 ">
            {person_imgs.map((item, index) => (
              <div
                key={index}
                className=" rounded-2xl   h-[25rem] w-[20rem] border-[0.5rem] border-teal-600 "
              >
                <div className=" h-4/5 ">
                  <img
                    src={item.img}
        ...
        <div className="md:flex-row flex flex-col">
          ...
          <div className="my-5 w-1/2 text-center flex flex-col justify-between ">
            <div className=" mb-4 text-3xl font-mono tracking-wider ">FAQs</div>
            ...
            <div className=" mb-4 text-3xl font-mono tracking-wider ">CONTACT US</div>
            <div className="flex justify-center">
            <div className="py-20 px-5 md:h-[20rem]  md:w-1/2  w-[90vw] bg-green-950 rounded-xl border-4 border-teal-500  ">
                    <div className="flex flex-col rounded-xl bg-teal-400 justify-center gap-2">
